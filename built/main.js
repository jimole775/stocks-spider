        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!['kline', 'quote', 'all'].includes(global.module)) return [3 /*break*/, 5];
                    console.log('Sniff stock home!');
                    return [4 /*yield*/, sniffStockHome(global.module)];
                case 4:
                    _a.sent();
                    _a.label = 5;
                case 5:
                    if (!['deal', 'all'].includes(global.module)) return [3 /*break*/, 7];
                ...
                case 6:
                    ...
                    _a.label = 7;
                case 7:
                    if (!['shadowline', 'all'].includes(global.module)) return [3 /*break*/, 9];
                ...
                case 8:
                    ...
                    _a.label = 9;
                case 9:
                    if (!['vline', 'all'].includes(global.module)) return [3 /*break*/, 11];
                ...
                case 10:
                    ...
                    _a.label = 11;
                case 11:
                    if (!['strokeline', 'all'].includes(global.module)) return [3 /*break*/, 13];
                ...
                case 12:
                    ...
                    _a.label = 13;
                case 13:
                    if (!['uline', 'all'].includes(global.module)) return [3 /*break*/, 15];
                ...
                case 14:
                    ...
                    _a.label = 15;
                case 15:
                    if (!['lowerpoint', 'all'].includes(global.module)) return [3 /*break*/, 17];
