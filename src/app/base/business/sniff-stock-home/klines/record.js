...
async function pickKline (recordItem) {
  ...
  // const file_week = path.join(global.db_stocks, stock, dataPath_week)
  // const file_month = path.join(global.db_stocks, stock, dataPath_month)
...
async function pickFRKline (recordItem) {
  ...
  const file = path.join(global.db_stocks, stock, fr_dataPath)
  // const file_week = path.join(global.db_stocks, stock, fr_dataPath_week)
  // const file_month = path.join(global.db_stocks, stock, fr_dataPath_month)
  await handleRecord(file, klineApi_daily)
  // await handleRecord(file_week, klineApi_week)
  // await handleRecord(file_month, klineApi_month)
  return Promise.resolve()
